...
declare namespace CodeceptJS {
  ...
  namespace Translation {
    interface Actions {
      ...
      "wait": "待つ",
      "clickSettingMenu": "設定メニューを開く",
      "capture": "スクリーンショットを.capttureに保存する",
      "clickSeat": "座席をクリックする",
      "clickSeatAlternative": "Altを押しながらざあ席をクリックする",
      "amOnPageWithArea": "場所と日付を指定して予約画面を開く",
      "getNextXday": "X日後の日付を取得する"
    }
  }
}
